...
<?php echo Html::beginForm(Yii::app()->createUrl('content/list'), 'get', '');?>
...
<div class="data">
  <div class="data_op_t">
    ...
    echo '</button></span>';
    ?>
    <span class="btn"><button onclick="location.href='<?php echo Yii::app()->createUrl('content/create')?>'">新增内容</button></span>
    </p>
  </div>
<?php $this->widget('application.components.IGridView', array(
    ...
    'columns'=>array(
                ...
                array(
                    'name'=>'categoryID',
                    'value'=>'Tb_category::model()->getNameByID($data->categoryID)',
                    'type' => 'raw',
                    'htmlOptions'=>array(
                        'style'=>'text-align:left',
                    )
