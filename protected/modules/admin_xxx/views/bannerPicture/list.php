...
<?php echo Html::beginForm(Yii::app()->createUrl('BannerPicture/list'), 'get', '');?>
...
<div class="data">
  <div class="data_op_t">
	...
	echo '</button></span>';
	?>
    <span class="btn"><button onclick="location.href='<?php echo Yii::app()->createUrl('BannerPicture/create')?>'">新增横幅图片</button></span>
    </p>
  </div>
