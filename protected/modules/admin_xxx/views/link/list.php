...
<?php echo Html::beginForm(Yii::app()->createUrl('link/list'), 'get', '');?>
...
<div class="data">
  <div class="data_op_t">
	...
	echo '</button></span>';
	?>
    <span class="btn"><button onclick="location.href='<?php echo Yii::app()->createUrl('link/create')?>'">新增友情链接</button></span>
    </p>
  </div>
