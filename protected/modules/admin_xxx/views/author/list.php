...
<?php echo Html::beginForm(Yii::app()->createUrl('author/list'), 'get', '');?>
...
<div class="senior_search" id="senior" style="display:none;">
 <?php echo Html::beginForm(Yii::app()->createUrl('author/list'), 'get', '');?>
  ...
  <p><label for="Tb_category_title">作者：</label><?php echo Html::activeTextField($model, 'title');?></p>
...
<div class="data">
  <div class="data_op_t">
	...
	echo '</button></span>';
	?>
    <span class="btn"><button onclick="location.href='<?php echo Yii::app()->createUrl('author/create')?>'">新增作者</button></span>
    </p>
  </div>
<?php $this->widget('application.components.IGridView', array(
    ...
    'columns'=>array(
				...
				array(
                    'name'=>'gid',
					'value'=>'Tb_category::model()->getParentNameByID($data->gid)',
					'type' => 'raw',
                    'htmlOptions'=>array(
                        'style'=>'text-align:left',
                    )
