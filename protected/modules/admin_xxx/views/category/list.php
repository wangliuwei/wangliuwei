...
<?php echo Html::beginForm(Yii::app()->createUrl('category/list'), 'get', '');?>
...
<div class="data">
  <div class="data_op_t">
	...
	echo '</button></span>';
	?>
    <span class="btn"><button onclick="location.href='<?php echo Yii::app()->createUrl('category/create')?>'">新增分类</button></span>
    </p>
  </div>
<?php $this->widget('application.components.IGridView', array(
    ...
    'columns'=>array(
				...
				array(
                    'header'=> '所属作者',
					'value'=>'Tb_category::model()->getNameByID($data->gid)',
					'type' => 'raw',
                    'htmlOptions'=>array(
                        'style'=>'text-align:left',
                    )
