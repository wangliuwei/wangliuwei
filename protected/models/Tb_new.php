 ...
 * @property integer $type 新闻类型 6:首页焦点|1:首页横幅|2:新闻|3:公司简介|4:酒文化|5:联系我们|7:购物保障|8:隐私声明|9博客链接
 */
class Tb_new extends ActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array_merge(parent::rules(), array(
            array('title,content,image', 'required', 'on'=>'create, update'),
            array('title', 'unique', 'on'=>'create, update'), //唯一
            //array('content', 'required', 'on'=>'contact'),
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            array('id, title, content,image, createDate,updateDate,type', 'safe', 'on'=>'search'),
        ));
    }
    ...
    public function attributeLabels()
    {
        return array_merge(parent::attributeLabels(), array(
            'title' => Yii::t('basic','标题'),
            'content' => Yii::t('basic', '内容'),
            'image' => Yii::t('basic', '上传图片'),
        ));
    }
